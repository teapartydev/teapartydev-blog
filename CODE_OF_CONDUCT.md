# PixelBend Code of Conduct

Welcome to the **PixelBend** repository! To maintain a respectful, productive, and inclusive community, we ask everyone to adhere to the following Code of Conduct.
...
We expect all participants in the PixelBend project to:
